...
void get_mpu6050_data()
{
  ...
  { // Get the Latest packet
   // display Euler angles in degrees
    ...
    dataBuffer.data.yaw = round(dataBuffer.data.yaw * 100) / 100.0;
    dataBuffer.data.pitch = round(dataBuffer.data.pitch * 100) / 100.0;
    dataBuffer.data.roll = round(dataBuffer.data.roll * 100) / 100.0;
  }
}
